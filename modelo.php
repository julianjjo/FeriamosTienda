...
function get_publicidad_activa(){
    $publicidades = get_publicidad_aleatoria();
    $publicidad_activa = array();
    $fecha_actual = date("Y-m-d");    
    $hora_actual = date( "H:i:s");
    foreach ($publicidades as $publicidad) {
        if($publicidad['fecha_inicio']<=$fecha_actual && $publicidad['fecha_fin']>= $fecha_actual && $publicidad['hora_de_inicio']<=$hora_actual && $publicidad['hora_de_fin']>= $hora_actual){
            $publicidad_activa[]=$publicidad;
        }
    } 
